...
<body>
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                <h1 class="card-title">All Posts <span> <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Create Post</button></span></h1>
                    @php 
                    $count=1;
                    @endphp
                    @if ($post)
